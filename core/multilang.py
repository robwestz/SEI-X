...
# Required fasttext import for production-grade language detection (>95% accuracy)
try:
    import fasttext
    ...
    logger.warning(
        "fasttext not installed. Language detection will use pattern-based fallback (~75% accuracy). "
